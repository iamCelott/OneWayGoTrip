...
@section('content')
                ...
                <div class="p-4 overflow-y-auto">
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" id="name" class="form-input rounded-md text-sm"
                            value="{{ old('name') }}" placeholder="write your category name here...">
                    </div>
                </div>
    ...
    <div class="card">
        <div class="card-header">
            <div class="flex justify-between items-center">
                <h4 class="card-title text-lg sm:text-2xl text-black">TRIP CATEGORIES</h4>
                <button class="btn bg-primary text-white outline-none text-xs sm:text-sm" data-fc-target="createModal"
                    data-fc-type="modal" type="button"><i class="far fa-plus mr-1"></i> <span>Add Category</span></button>
            </div>
        </div>
        <div class="p-6">
                                ...
                                <tbody class="gridjs-tbody">
                                    @forelse ($categories as $index => $category)
                                        <tr class="gridjs-tr text-center">
                                            ...
                                            <td data-column-id="name" class="gridjs-td">{{ $category->name }}</td>
                                                ...
                                                <div>
                                                    ...
                                                    <div
                                                        ...
                                                        <button
                                                            ...
                                                            data-fc-target="editModal" data-id="{{ $category->id }}"
                                                            data-name="{{ $category->name }}" data-fc-type="modal"
                                                        ...
                                                        <button
                                                            ...
                                                            data-fc-target="deleteModal" data-id="{{ $category->id }}"
                                                            data-name="{{ $category->name }}" data-fc-type="modal"
    ...
    <script>
        $(document).on('click', '.editModalBtn', function() {
            ...
            $('#editTittle').html("Edit Category " + name);
        ...
        $(document).on('click', '.deleteModalBtn', function() {
            ...
            $('#deleteTittle').html("Delete Category " + name);
        })
    </script>
@endsection
